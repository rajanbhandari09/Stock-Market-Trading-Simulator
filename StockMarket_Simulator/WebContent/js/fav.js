  ...
  Stock.prototype.domElementUpdate = function(parentDomElement)
  {
    if (this.domElement == null)
    {
      var tr = document.createElement("tr");
       tr.setAttribute('style', 'font-family: Arial,Helvetica,sans-serif; font-size: 14px; padding: 0px 2px;');
...
}
{
  ...
  StockTracker.prototype.domElementUpdate = function()
  {
    ...
    if (this.domElement == null)
    {
      ...
      inputSymbolToAdd.setAttribute('style','form-control;');
      inputSymbolToAdd.setAttribute('placeholde','Add Fav');
      ...
      var tr = document.createElement("tr");
       tr.setAttribute('style', 'font-size: 14px; font-family: Arial,Helvetica,sans-serif; font-weight: bold; color:#DDDD55;');
    ...
    document.getElementById("tableQuotes").className = "rwd-table";
  }
